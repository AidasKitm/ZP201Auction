...
from wtforms.fields import StringField, IntegerField, TimeField, TextAreaField, SelectField
...
class AuctionForm(FlaskForm):
    ...
    end_day = StringField('End day', validators=[InputRequired('Input needed')])
